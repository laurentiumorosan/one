...
if __name__ == '__main__':
    ...
    print 'Private SMTP Bruter Force'
    print 'Coded by Hallo World'
    print 'Jabber bilalkhanicom@jabber.me - Skype kbksrb@msn.com'
    print 'Private SMTP RDP SSH Root Cpanel Scanners Bruters For Sale'
    par = raw_input('Input Password to continue ')
    if par != '12345':
       print 'Password wrong. Contact me on Jabber ID: bilalkhanicom@jabber.me'
    else:
